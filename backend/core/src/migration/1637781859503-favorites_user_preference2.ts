...
export class favoritesUserPreference21637781859503 implements MigrationInterface {
  name = "favoritesUserPreference21637781859503"

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "jurisdictions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" text NOT NULL, "notifications_sign_up_url" text, CONSTRAINT "UQ_60b3294568b273d896687dea59f" UNIQUE ("name"), CONSTRAINT "PK_7cc0bed21c9e2b32866c1109ec5" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "preferences" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "ordinal" integer, "title" text, "subtitle" text, "description" text, "links" jsonb, "form_metadata" jsonb, "page" integer, "listing_id" uuid, CONSTRAINT "PK_17f8855e4145192bbabd91a51be" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "property" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "accessibility" text, "amenities" text, "building_total_units" integer, "developer" text, "household_size_max" integer, "household_size_min" integer, "neighborhood" text, "pet_policy" text, "smoking_policy" text, "units_available" integer, "unit_amenities" text, "services_offered" text, "year_built" integer, "building_address_id" uuid, CONSTRAINT "REL_f0f7062f34738e0b338163786f" UNIQUE ("building_address_id"), CONSTRAINT "PK_d80743e6191258a5003d5843b4f" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "listing_events" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "type" "listing_events_type_enum" NOT NULL, "start_time" TIMESTAMP WITH TIME ZONE, "end_time" TIMESTAMP WITH TIME ZONE, "url" text, "note" text, "label" text, "listing_id" uuid, "file_id" uuid, CONSTRAINT "PK_a9a209828028e14e2caf8def25c" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "listings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "hrd_id" text, "additional_application_submission_notes" text, "digital_application" boolean, "common_digital_application" boolean, "paper_application" boolean, "referral_opportunity" boolean, "assets" jsonb NOT NULL, "application_due_date" TIMESTAMP WITH TIME ZONE, "application_due_time" TIMESTAMP WITH TIME ZONE, "application_open_date" TIMESTAMP WITH TIME ZONE, "application_fee" text, "application_organization" text, "application_pick_up_address_office_hours" text, "application_pick_up_address_type" "listings_application_pick_up_address_type_enum", "application_drop_off_address_office_hours" text, "application_drop_off_address_type" "listings_application_drop_off_address_type_enum", "building_selection_criteria" text, "costs_not_included" text, "credit_history" text, "criminal_background" text, "deposit_min" text, "deposit_max" text, "disable_units_accordion" boolean, "leasing_agent_email" text, "leasing_agent_name" text, "leasing_agent_office_hours" text, "leasing_agent_phone" text, "leasing_agent_title" text, "name" text NOT NULL, "postmarked_applications_received_by_date" TIMESTAMP WITH TIME ZONE, "program_rules" text, "rental_assistance" text, "rental_history" text, "required_documents" text, "special_notes" text, "waitlist_current_size" integer, "waitlist_max_size" integer, "what_to_expect" text, "status" "listings_status_enum" NOT NULL DEFAULT 'pending', "review_order_type" "listings_review_order_type_enum", "display_waitlist_size" boolean NOT NULL, "csv_formatting_type" character varying NOT NULL DEFAULT 'basic', "reserved_community_description" text, "reserved_community_min_age" integer, "result_link" text, "is_waitlist_open" boolean, "waitlist_open_spots" integer, "owner_company" text, "management_company" text, "management_website" text, "ami_percentage_min" integer, "ami_percentage_max" integer, "custom_map_pin" boolean, "phone_number" text, "region" text, "property_id" uuid NOT NULL, "application_address_id" uuid, "application_pick_up_address_id" uuid, "application_drop_off_address_id" uuid, "application_mailing_address_id" uuid, "building_selection_criteria_file_id" uuid, "jurisdiction_id" uuid, "leasing_agent_address_id" uuid, "reserved_community_type_id" uuid, "image_id" uuid, "result_id" uuid, CONSTRAINT "PK_520ecac6c99ec90bcf5a603cdcb" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user_preferences" ("send_email_notifications" boolean NOT NULL DEFAULT false, "send_sms_notifications" boolean NOT NULL DEFAULT false, "favorites" jsonb NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "REL_458057fa75b66e68a275647da2" UNIQUE ("user_id"), CONSTRAINT "PK_458057fa75b66e68a275647da2e" PRIMARY KEY ("user_id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "user_accounts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "password_hash" character varying NOT NULL, "reset_token" character varying, "confirmation_token" character varying, "confirmed_at" TIMESTAMP WITH TIME ZONE, "email" character varying NOT NULL, "first_name" character varying NOT NULL, "middle_name" character varying, "last_name" character varying NOT NULL, "dob" TIMESTAMP, "phone_number" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "language" character varying, CONSTRAINT "UQ_df3802ec9c31dd9491e3589378d" UNIQUE ("email"), CONSTRAINT "PK_125e915cf23ad1cfb43815ce59b" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "translations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "language" character varying NOT NULL, "translations" jsonb NOT NULL, "jurisdiction_id" uuid, CONSTRAINT "REL_181f8168d13457f0fd00b08b35" UNIQUE ("jurisdiction_id"), CONSTRAINT "PK_aca248c72ae1fb2390f1bf4cd87" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
