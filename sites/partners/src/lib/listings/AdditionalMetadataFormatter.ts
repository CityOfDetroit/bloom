...
export default class AdditionalMetadataFormatter extends Formatter {
  ...
  process() {
    ...
    if (this.data.marketingType === ListingMarketingTypeEnum.marketing) {
      ...
      this.data.whatToExpect = `This property is still under construction by the property owners. If you sign up for notifications through Detroit Home Connect, we will send you updates when this property has opened up applications for residents. You can also check back later to this page for updates.`
