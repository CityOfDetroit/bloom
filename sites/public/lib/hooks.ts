...
const listingsFetcher = function () {
  return async (url: string, page: number, limit: number, filters: ListingFilterState) => {
...
export function useListingsData(pageIndex: number, limit = 10, filters: ListingFilterState) {
